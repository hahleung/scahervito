...
import kyu6.RainfallTest._
import org.scalatest._

class RainfallTest extends FlatSpec with Matchers {
  "Rain.mean" should "pass fixed tests with data" in {
    Rainfall.mean("London", data) should equal(51.199999999999996 +- 1e-2)
  }

  "Rain.mean" should "pass exact match" in {
    Rainfall.mean("Lon", data) should equal(-1.0 +- 1e-2)
  }
...
object RainfallTest {
  ...
  var towns: Array[String] = Array("Rome", "London", "Paris", "NY", "Vancouver", "Sydney", "Bangkok", "Tokyo", "Beijing", "Lima", "Montevideo", "Caracas", "Madrid", "Berlin", "Lon")
}
